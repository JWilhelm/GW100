...
do
  ...
  if [ $dirname == '23_C4H10' ] || [$dirname == '27_C3H6'] || [ $dirname == '28_C6H6' ] || [ $dirname == '29_C8H8' ] || [ $dirname == '30_C5H6' ] || [ $dirname == '37_CBr4' ] || [ $dirname == '42_Si5H12' ] || [ $dirname == '56_TiF4' ] || [ $dirname == '64_AlI3' ] || [ $dirname == '73_C4H10O4' ] || [ $dirname == '86_C7H8' ] || [ $dirname == '87_C8H10' ] || [ $dirname == '88_C6F6' ] || [ $dirname == '89_C6H5OH' ] || [ $dirname == '90_C6H5NH2' ] || [ $dirname == '91_C5H5N' ] || [ $dirname == '92_guanine' ] || [ $dirname == '93_adenine' ] || [ $dirname == '94_cytosine' ] || [ $dirname == '95_thymine' ] || [ $dirname == '96_uracil' ] ; then

    sed -i -e 's/<nodes>/8/g' $submitfile

  elif [ $dirname == '38_CI4' ] ; then

    sed -i -e 's/<nodes>/16/g' $submitfile
  ...
  if [ $dirname == '56_TiF4' ] || [ $dirname == '65_BN' ] || [ $dirname == '67_PN' ] || [ $dirname == '81_CO' ] || [ $dirname == '84_BeO' ] || [ $dirname == '85_MgO' ]  ; then
      cp $wfndir'/'$dirname'/ALL_ELEC-RESTART.wfn' .
      echo 'Copied WFN for   '$xyzname'.'
  fi

  if [ $dirname == '42_Si5H12' ] || [$dirname == '10_Na6'] ; then
      sed -i -e 's/ABC 16.0 16.0 16.0/ABC 16.0 26.0 16.0/g' $GWfile
  fi
